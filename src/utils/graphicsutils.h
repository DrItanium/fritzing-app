...
public:
    using DistanceFromLineResults = std::tuple<double, double, double, bool>;
    ...
    static constexpr DistanceFromLineResults distanceFromLine(double cx, double cy, double ax, double ay, double bx, double by) noexcept {
        ...
        return std::make_tuple(dx, dy, distanceSegment, atEndpoint);
    }
	...
	static double getNearestOrdinate(double ordinate, double units) noexcept;
